    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form id="validation" action="{{ route('form/save') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="tel" class="form-control" id="sex" name="sex" placeholder="Enter Sex" required>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="tel" class="form-control" id="country" name="country" placeholder="Enter Country" required>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="facebook_name" name="facebook_name" placeholder="Enter Facebook Name" required>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="youtube_name" name="youtube_name" placeholder="Enter YouTube Name" required>
                            <div class="clearfix"></div>
                        </div>
                    </div>
