...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{URL::to('assets/img/favicon.ico')}}">
    ...
    <link rel="stylesheet" href="{{URL::to('assets/libs/flot/flot.css')}}">
                            ...
                            <div class="demo-navbar-messages nav-item dropdown mr-lg-3">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="list-group list-group-flush">
                                        ...
                                        <a href="javascript:" class="list-group-item list-group-item-action media d-flex align-items-center">
                                            <img src="{{URL::to('assets/img/avatars/4-small.png')}}" class="d-block ui-w-40 rounded-circle" alt>
                                            <div class="media-body ml-3">
                                        ...
                                        <a href="javascript:" class="list-group-item list-group-item-action media d-flex align-items-center">
                                            <img src="{{URL::to('assets/img/avatars/5-small.png')}}" class="d-block ui-w-40 rounded-circle" alt>
                                            <div class="media-body ml-3">
                                        ...
                                        <a href="javascript:" class="list-group-item list-group-item-action media d-flex align-items-center">
                                            <img src="{{URL::to('assets/img/avatars/11-small.png')}}" class="d-block ui-w-40 rounded-circle" alt>
                                            <div class="media-body ml-3">
                            ...
                            <div class="demo-navbar-user nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                                    <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                                        <img src="{{URL::to('assets/img/avatars/1.png')}}" alt class="d-block ui-w-30 rounded-circle">
                                        <span class="px-1 mr-lg-2 ml-2 ml-lg-0">{{ Auth::user()->name }}</span>
                                    </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="javascript:" class="dropdown-item"  data-toggle="modal" data-target="#ViewProfile">
            ...
            <div class="modal-body">
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="v_name"name="name" class="form-control" value="{{ Auth::user()->name }}" readonly/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Email Address</label>
                        <div class="col-sm-9">
                            <input type="text" id="v_email"name="email" class="form-control" value="{{ Auth::user()->email }}" readonly/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Phone Number</label>
                        <div class="col-sm-9">
                            <input type="tel" id="v_phone_number"name="mobile" class="form-control" value="{{ Auth::user()->phone_number }}" readonly/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Group ID</label>
                        <div class="col-sm-9">
                            <input type="text" id="v_groupid"name="groupid" class="form-control" value="{{ Auth::user()->group_id }}" readonly/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Role Name</label>
                        <div class="col-sm-9">
                            <input type="text" id="v_role_name"name="role_name" class="form-control" value="{{ Auth::user()->role_name }} " readonly/>
                        </div>
                    </div>
                </div>
                <!-- form add end -->
...
<!-- End Modal User-->
    ...
    <script src="{{URL::to('assets/libs/eve/eve.js')}}"></script>
    <script src="{{URL::to('assets/libs/flot/flot.js')}}"></script>
    <script src="{{URL::to('assets/libs/flot/curvedLines.js')}}"></script>
    <script src="{{URL::to('assets/libs/chart-am4/core.js')}}"></script>
    <script src="{{URL::to('assets/libs/chart-am4/charts.js')}}"></script>
    <script src="{{URL::to('assets/libs/chart-am4/animated.js')}}"></script>

    <!-- Demo -->
    <script src="{{URL::to('assets/js/demo.js')}}"></script>
    <script src="{{URL::to('assets/js/analytics.js')}}"></script>
    <script src="{{URL::to('assets/js/pages/dashboards_index.js')}}"></script>
